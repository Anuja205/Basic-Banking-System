...
<body >
	...
	<div id="header">
       <br>
       <h1 style=" font-family:Agency FB; font-size: 70px; color:#306E12;text-shadow: 2px 2px black;"> Sparks Foundation Internship Project </h1>
       <h2 style=" font-family:Agency FB; font-size: 55px;color:white;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Basic Banking System </h2>
    </div>
        <div id="section">
            <table>
                <tr></tr>
